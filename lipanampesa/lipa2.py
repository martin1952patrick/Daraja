...
from .models import STKPushDaraja
...
def lipa_na_mpesa():
    ...
    request = {
        ...
        "CallBackURL": "https://mpesadara.com/lipanampesa",
        "AccountReference": "247247",
        "TransactionDesc": "Welcome"
    }
    ...
    stkpush_response = STKPushDaraja.objects.create(
